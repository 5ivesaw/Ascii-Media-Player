...
You can download the latest **standalone Windows `.exe` build** from the [Releases](https://www.mediafire.com/file/488ytx7sp1xx7xp/Ascii+Media+Player.exe/file) section. Or if you want the python download it [here](https://github.com/goatdotlol/Ascii-Media-Player/raw/main/app.py)
